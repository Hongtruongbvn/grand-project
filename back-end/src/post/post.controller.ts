import { Controller, Post as HttpPost, Body, Req, UseGuards, Param, Put, ForbiddenException, Delete } from '@nestjs/common';
...
export class PostsController {
  ...
  @UseGuards(JwtAuthGuard) // Đảm bảo đã đăng nhập
  @HttpPost()
