...
export default function GroupPage() {
  ...
  if (loading)
    return <div className={styles.pageLoader}>Đang tải thông tin nhóm...</div>;
  if (!group)
    return <div className={styles.pageLoader}>Không tìm thấy nhóm.</div>;
    ...
    <>
      <div className={styles.groupPage}>
        <div
          ...
          style={{
            backgroundImage: `url(http://localhost:9090/uploads${group.group_background})`,
